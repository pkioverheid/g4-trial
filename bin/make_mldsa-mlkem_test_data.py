...
with open("testdata/csr/certs/statement-of-possession-ca.key", "wb") as f:
    f.write(ca_key.public_bytes(
...
with open("testdata/csr/certs/statement-of-possession-signing.key", "wb") as f:
    f.write(signature_key.public_bytes(
        serialization.Encoding.PEM,
        serialization.PrivateFormat.PKCS8,
        encryption_algorithm=serialization.NoEncryption()
    ))
